...
class TransactionViewSet(ModelViewSet):
    ...
    def perform_create(self, serializer: TransactionSerializer) -> None:
        ...
        amount_in_currency = serializer.validated_data.pop('amount_in_usd', 0) * currency.rate
        tax_in_currency = serializer.validated_data.pop('tax_in_usd', 0) * currency.rate
        serializer.save(
            status=status,
